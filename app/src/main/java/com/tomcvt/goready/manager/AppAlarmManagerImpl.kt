...
open class AppAlarmManagerImpl(
    ...
    override fun scheduleSnoozeById(alarmId: Long, remainingSnooze: Int, snoozeTimeMinutes: Int) {
        systemScheduler.scheduleSnooze(alarmId, remainingSnooze, snoozeTimeMinutes)
    }

    override suspend fun updateAlarm(draft: AlarmDraft, alarmId: Long) {
    ...
    companion object {
        private const val TAG = "AppAlarmManagerImpl"
